        ...
        public function add_user() {
         ...
         if($this->input->post()) {
            ...
            if($this->form_validation->run()== FALSE) {
                $this->load->view('users/adduser_view');
             }else {
                ...
                if($this->user_model->add_user($formArray)) {
                    $this->session->set_flashdata("msg1", "user has been registered");
                    redirect(base_url().'index.php/user/user_manage');
                }
